...
/** Read-only for now. Editing profile, members and API keys arrives in phases 2B and 3A. */
export function ProfileSummary() {
  ...
  return (
    <dl className="max-w-2xl divide-y divide-line rounded-menu border border-line">
